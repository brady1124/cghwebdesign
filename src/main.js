...
document.querySelector('#app').innerHTML = `
  ...
  <main>
    <section class="hero" id="home" data-hero>
      <img class="hero-image" src="./assets/cgh-web-design-hero.png" alt="CGH Web Design futuristic logo artwork" />
      ...
      <div class="hero-content">
        ...
        <p class="hero-text">
          CGH Web Design creates responsive websites, brand-forward visuals, and conversion-ready digital experiences for businesses that need to look sharp from the first click.
        </p>
      ...
      <div class="hero-metrics" aria-label="CGH Web Design highlights">
        ...
        <div>
          <strong>Fast</strong>
          <span>Vercel-ready delivery</span>
        </div>
      </div>
    </section>
    ...
    <section class="section intro">
      ...
      <p>
        We pair clear messaging with crisp layouts, strong visuals, and responsive engineering so visitors know who you are, what you do, and how to take the next step.
      </p>
    </section>
    ...
    <section class="section services" id="services">
      ...
      <div class="card-grid">
        <article class="service-card">
          ...
          <h3>New Website Builds</h3>
          <p>Custom sites designed from the ground up for credibility, clarity, and momentum.</p>
        </article>
        <article class="service-card">
          <span class="card-index">02</span>
          <h3>Website Updates</h3>
          <p>Refresh copy, sections, visuals, navigation, and calls-to-action without losing your brand foundation.</p>
        </article>
        <article class="service-card">
          <span class="card-index">03</span>
          <h3>Redesigns</h3>
          <p>Modernize dated sites with sharper structure, responsive layouts, and stronger conversion paths.</p>
        </article>
        <article class="service-card">
          <span class="card-index">04</span>
          <h3>Performance & SEO</h3>
          <p>Improve speed, technical quality, and search-friendly foundations so your site works harder.</p>
        </article>
      </div>
    </section>
    ...
    <section class="section process" id="process">
      ...
      <div class="timeline">
        <article>
          ...
          <p>We clarify audience, services, content needs, and the action each page should drive.</p>
        </article>
        <article>
          <span>Design</span>
          <h3>Shape the experience</h3>
          <p>We craft a visual system that feels premium, readable, and unmistakably yours.</p>
        </article>
        <article>
          <span>Build</span>
          <h3>Engineer for every screen</h3>
          <p>We assemble responsive sections with smooth interactions and clean deployment paths.</p>
        </article>
        <article>
          <span>Launch</span>
          <h3>Ship with confidence</h3>
          <p>We verify the site, polish the details, and prepare it for Vercel deployment.</p>
        </article>
      </div>
    </section>
        ...
        <form class="contact-form" action="https://api.web3forms.com/submit" method="POST" data-contact-form>
          ...
          <label>
            ...
            <select name="inquiry_type" required>
              ...
              <option>Build New Website</option>
              <option>Update Existing Website</option>
              <option>Website Redesign</option>
              <option>SEO / Performance Help</option>
